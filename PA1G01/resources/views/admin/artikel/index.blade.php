                                ...
                                <tbody>
                                    @forelse($artikel as $row)
                                        <tr>
                                            ...
                                            <td> {{ $shortBody }}...</td>
                                            <td>
                                                @if ($row->gambar_article)
                                                    @if (Str::endsWith($row->gambar_article, ['.jpeg', '.png', 'jpg']))
                                                        <img src="{{ asset('uploads/artikel/' . $row->gambar_article) }}" width="80">
                                                    @else
                                                        <embed src="{{ asset('uploads/artikel/' . $row->gambar_article) }}" width="80" type="{{ mime_content_type(public_path('uploads/artikel/' . $row->gambar_article)) }}">
                                                    @endif
                                                @else
                                                    -
                                                @endif
