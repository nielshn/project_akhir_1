                ...
                <div class="card full-height">
                    <div class="card-header">
                        <div class="card-head-row d-flex">
                            ...
                            <a href="{{ route('faq.create') }}" class="btn btn-primary btn-sm ml-auto"><i
                                    class="fa fa-plus"></i> &nbsp;{{ __('Add FAQ') }}</a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @forelse($faq as $row)
                                        <tr>
                                            ...
                                            <?php
                                            $bodyWords = str_word_count(strip_tags($row->pertanyaan), 1);
                                ...
                                <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Data FAQ</h5>
