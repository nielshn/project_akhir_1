                ...
                <div class="col-lg-8">
                    <div class="row g-2">
                        ...
                        <div class="blog-img position-relative overflow-hidden">
                            @if (file_exists(public_path('uploads/artikel/' . $artikel->gambar_article)))
                                @php
                                    $resizedImage = Image::make(public_path('uploads/artikel/' . $artikel->gambar_article))->fit(600, 400);
                                @endphp
