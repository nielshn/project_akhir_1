        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card mb-4 shadow">
                    <div class="card-body">
                        <h2 class="card-title" style="font-size: 28px; font-weight: bold; margin-bottom: 1.5rem;">
                            {{ $menu->meta_title }}</h2>
            ...
            <div class="col-md-4">
                <div class="card mb-4 shadow">
                    <div class="card-body">
                        <h2 class="card-title" style="font-size: 20px; font-weight: bold; margin-bottom: 1.5rem;">Kegiatan
                            Terbaru</h2>
                            ...
                            <div class="rpwe-li d-flex mb-3">
                                @if (file_exists(public_path('uploads/event/' . $row->gambar_event)))
                                    ...
                                    <img class="img-fluid me-3"
                                        style="object-fit: cover; border-radius: 8px; box-shadow: 0px 3px 5px 0px rgba(0,0,0,0.1);"
                                        src="{{ $resizedImage->encode('data-url') }}" alt="Event Image">
                                @else
                                    <div class="image-not-found me-3"
                                        style="border-radius: 8px; box-shadow: 0px 3px 5px 0px rgba(0,0,0,0.1);">
                                ...
                                <div class="rpwe-content">
                                    ...
                                    ?>
                                    <h6 class="card-title" style="font-size: 18px;"><a
                                            href="{{ route('detailEvent', [$row->id, $row->slug]) }}"
                                            class="text-primary">{{ $shortBody }}...</a></h6>
                                    <small class="text-muted"
                                        style="font-size: 14px;">{{ Carbon\Carbon::parse($row->created_at)->format(' F d, Y') }}</small>
                                </div>
                            </div>
                            <hr>
                        @endforeach
